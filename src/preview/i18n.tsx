...
const EN = {
  ...
  oneDownloaded: "✓ {name} downloaded",
  downloadThis: "Download this card",
  downloadThisCard: "↓ This card",
  selectForExport: "Select for download",
  selectedCount: "{n} selected",
  exportSelected: "↓ Download {n}",
...
const KO: Dict = {
  ...
  oneDownloaded: "✓ {name} 다운로드 완료",
  downloadThis: "이 카드만 다운로드",
  downloadThisCard: "↓ 이 카드",
  selectForExport: "다운로드할 카드 선택",
  selectedCount: "{n}장 선택됨",
  exportSelected: "↓ {n}장 받기",
  selectAll: "모두 선택",
  clearSelection: "해제",
