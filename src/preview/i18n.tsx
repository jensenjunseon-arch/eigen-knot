...
const EN = {
  ...
  perCardSeconds: "Seconds per card · {s}s",
  capturing: "Capturing",
  ...
  videoNote: "{n} cards × per-card time ≈ {sec}s, {w}×{h} MP4. Hard cuts (no animation). Encoded in your browser; first run loads the encoder once.",
  // gallery
...
const KO: Dict = {
  ...
  videoNote: "카드 {n}장 × 카드당 시간 ≈ {sec}초, {w}×{h} MP4. 하드컷(애니메이션 없음). 브라우저에서 인코딩하며, 처음 한 번 인코더를 불러옵니다.",
  galleryClose: "✕ 그리드로",
